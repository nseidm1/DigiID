...
JNIEXPORT jbyteArray JNICALL Java_com_noahseidman_digiid_models_KeyModel_compactSign(
        JNIEnv *env,
        jobject thiz,
        jbyteArray data) {
...
JNIEXPORT jboolean JNICALL Java_com_noahseidman_digiid_models_KeyModel_setPrivKey(
        JNIEnv *env,
        jobject thiz,
        jbyteArray privKey) {
...
JNIEXPORT void JNICALL Java_com_noahseidman_digiid_models_Key_setSecret(
        JNIEnv *env,
        jobject thiz,
        jbyteArray privKey) {
//    __android_log_print(ANDROID_LOG_ERROR, "Message from C: ", "key is not set yet, _key: %s", _key.secret);
...
JNIEXPORT jbyteArray JNICALL Java_com_noahseidman_digiid_models_Key_encryptNative(JNIEnv *env, jobject thiz,
                                                                      jbyteArray data,
                                                                      jbyteArray nonce) {
...
JNIEXPORT jbyteArray JNICALL Java_com_noahseidman_digiid_models_Key_decryptNative(JNIEnv *env, jobject thiz,
                                                                      jbyteArray data,
                                                                      jbyteArray nonce) {
    jbyte *byteData = (*env)->GetByteArrayElements(env, data, NULL);
    jbyte *byteNonce = (*env)->GetByteArrayElements(env, nonce, NULL);
...
JNIEXPORT jstring JNICALL Java_com_noahseidman_digiid_models_KeyModel_address(JNIEnv *env, jobject thiz) {
